 ...
 * @author 3oxic
 */
public class CompanyCustomerGui extends JFrame {
   
    String customerusername = "";
    
    public CompanyCustomerGui(String customer)
    {
            ...
            public void actionPerformed(ActionEvent e) {
               ...
               cameraproduct = (CameraProduct)((JButton)e.getSource()).getClientProperty( "cameraproduct" );
                try {
                    ...
                    Logger.getLogger(CompanyCustomerGui.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            c.gridx++;
             ...
             basketbutton.addActionListener(new ActionListener()
             {
                public void actionPerformed(ActionEvent e) 
                {
                    ...
                    try {
                        CompanyCustomerBasketGui showbasket = new CompanyCustomerBasketGui(cname);
                    } catch (SQLException ex) {
                        Logger.getLogger(CompanyCustomerGui.class.getName()).log(Level.SEVERE, null, ex);
                    }
